...
public class Produkt {
	...
	private double cena;
	private String data_modyfikacji;
	
	public Produkt() {
		// TODO Auto-generated constructor stub
	}
	
	public Produkt(String nazwa_produktu, String data_dodania, String miara, double cena, String data_modyfikacji){
	...
	public Produkt(String nazwa_produktu, String data_dodania, String miara, double cena){
		this.nazwa_produktu=nazwa_produktu;
		this.data_dodania = data_dodania;
		this.miara=miara;
		this.cena=cena;
	...
	public String getData_modyfikacji() {
		return data_modyfikacji;
	}

	public void setData_modyfikacji(String data_modyfikacji) {
		this.data_modyfikacji = data_modyfikacji;
	}
}
