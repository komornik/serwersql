...
CREATE TABLE IF NOT EXISTS `hurtownia`.`ulica` (
  ...
  `kod_poczt_id` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hurtownia`.`klient` (
  ...
  `telefon` INT NULL,
  `rabat_id` INT NULL DEFAULT NULL,
  `ulica_id` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hurtownia`.`stan_magazynowy` (
  ...
  `magazyn_id` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hurtownia`.`rozchody` (
  ...
  `stan_magazynowy_id` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `hurtownia`.`przychod`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hurtownia`.`przychod` (
