...
public class Faktura {
	...
	public Faktura(String nr_faktury, String sciezka, Date data_wystawienia,
			int klient_id) {
	...
	@JoinTable(name = "zamowienie_has_faktura", joinColumns = { @JoinColumn(name = "faktura_id") }, inverseJoinColumns = { @JoinColumn(name = "zamowienie_id") })
